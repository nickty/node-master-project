...
const httpServer = http.createServer((req, res) => {
  ...
  req.on('end', () => {
    ...
    // if the request is whthin the public registry choose public handler
    chosenHandler =
      trimmedPath.indexOf('/public/') > -1 ? hanlders.public : chosenHandler;
...
const router = {
  ...
  '/favicon.ico': hanlders.favicon,
  '/public': hanlders.public,
};
